...
* `create_infotables()` creates WOE or NWOE tables for all variables in the input dataframe. Also produces a variable-strength summary data.frame.
...
The MultiPlot() function plots multiple variables on the same page. If we are plotting more than nine variables, MultiPlot will simply spread the plots over multiple pages. Here we are plotting the top four variables:
